...
<button
  ...
  class={cn(
    'flex w-full cursor-pointer flex-col items-center justify-center gap-5 rounded-xl border-2 border-dashed p-8 text-center transition-colors sm:gap-6 sm:p-16',
...
>
  ...
  <div class="space-y-1.5">
    <p class="text-base font-medium sm:text-lg">Drop, paste or pick your SVG</p>
  ...
  <div
    class="flex flex-col items-center gap-2 text-xs text-neutral-500 sm:flex-row sm:gap-5 sm:text-sm dark:text-neutral-400"
  >
